...
vec2 rayMinMax(vec3 pos, vec3 dir, float t0, float t1, sampler3D opacity,
               VolumeParameters opacityParameters, vec3 cellDim, sampler3D volumeData, VolumeParameters volumeParameters, sampler2D tf) {
...
vec3 rayMinMaxAvgTest(vec3 pos, vec3 dir, float t0, float t1, sampler3D opacity,
               VolumeParameters opacityParameters, vec3 cellDim, sampler3D volumeData, VolumeParameters volumeParameters, sampler2D tf, inout vec3 auxReturn) {

...
nframes = 10000
timers = [opactopt.timeSetup, opactopt.timeRasterisation, opactopt.timeProjection,
          opactopt.timeSmoothing, opactopt.timeBlending]
...
ncoeffs = 5
filename = dataset + "-abuffer-renderereval-" + str(ncoeffs) + ".csv"
fields = ["Approximation method", "Coefficients", "App time", "Sum time", "Setup time", "Rasterisation time", "Projection time", "Smoothing time", "Blending time"]

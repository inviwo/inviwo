...
class InviwoAPI {
   ...
   * @param propertyObserver callback that will be called on PropertyObserver notifications in inviwo.
  ...
  async setProperty(path, parameters, onSuccess = function(response){},
                    onFailure = function(error_code, error_message){}) {
    window.cefQuery({
        request: JSON.stringify({"command":"property.set", "path": path, "parameters": parameters}),
        onSuccess: function(response) {
